...
project = "ocrtesting"
copyright = (
    f"{date.today().year} Sean Garrett-Roe.\n"
    "Project structure based on the "
    "Computational Molecular Science Python Cookiecutter version 1.10"
)
author = "Sean Garrett-Roe"


# The short X.Y version
package_version = metadata.version("ocrtesting")

version = "v" + ".".join(package_version.split(".")[:2])
...
htmlhelp_basename = "ocrtestingdoc"
...
texinfo_documents = [
    (
        ...
        author,
        "ocrtesting",
        "Process scans for Growth-Oriented Testing",
        "Miscellaneous",
    ),
]
